...
accuracy of the predictions, the *area under the ROC Curve* ([auc](measures.md)) 
...
via a *wrapping-based approach* ([wrappers](wrapper.md)). In this way
...
the [wrapping-approach](wrapper.md).
