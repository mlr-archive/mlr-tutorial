...
By doing a random sampling of the data set (i.e. non-spatial sampling), training and test set data are often located directly next to each other (in a spatial meaning).
Hence, the test set will contain observations which are somehwat similar (due to spatial autocorrelation) to observations in the training set. 
