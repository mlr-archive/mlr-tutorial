...
* [ClassifTask](&Task) for binary and multi-class classification problems
  (normal [cost-sensitive classification](cost_sensitive_classif.md) with class-dependent costs
...
*negative* class with the positive class normally being the category of greater interest.
This distinction is of course relevant for many [performance measures](performance.md)
...
In case of *class-dependent costs*, that depend on the actual and predicted class labels only, it
...
Note that [task description](&TaskDesc)s have slightly different elements for different
types of [&Task]s.
