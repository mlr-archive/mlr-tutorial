...
For frequently needed elements of the task description there also exist separate getter functions.
```{r}
## Get the ID
getTaskId(regr.task)

## Get the type of task
getTaskType(regr.task)

## Get the names of the target columns
getTaskTargetNames(regr.task)

## Get the number of observations
getTaskSize(regr.task)

## Get the number of input variables
getTaskNFeats(regr.task)
```
...
package into [%mlr].
In this regard the functions [&getTaskFormula] is also useful.
