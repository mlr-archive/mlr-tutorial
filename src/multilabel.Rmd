...
classification problems. Algorithm adaption methods adapt multiclass algorithms
...
* Apply directly a algorithm adaption method which treats the whole 
...
Currently the only available algorithm adaption method in **R** is the Random Ferns 
