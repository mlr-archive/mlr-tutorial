...
When specifying the [task](task.md), you need to provide spatial coordinates through argument `coordinates`.
...
The [task](task.md) argument `coordinates` is a `data.frame` with two coordinates that will later be used for the spatial partitioning of the data set.
