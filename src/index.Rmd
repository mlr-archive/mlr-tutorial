# [Machine Learning in R: mlr](https://github.com/mlr-org/mlr) Tutorial
This `r if (dev == "pdf") "document" else "web page"` provides an in-depth introduction on
how to use the [Machine Lerning in R: mlr](https://github.com/mlr-org/mlr) framework for
...
## Quick start
A simple stratified cross-validation of [linear discriminant analysis](&MASS::lda) with [%mlr].
```{r}
library(mlr)
data(iris)
