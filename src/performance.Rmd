...
Helpful in this regard are the functions [&generateThreshVsPerfData] and [&plotThreshVsPerf], which generate and plot, respectively, the learner performance versus the threshold.
