...
For binary classification specialized techniques exist to analyize the performance. 
...
one matrix, see for example the [receiver operator characteristic page on wikipedia](https://en.wikipedia.org/wiki/Receiver_operating_characteristic).
...
abbreviations can be toggled in the print function with `print(r, abbreviations = FALSE)`.
