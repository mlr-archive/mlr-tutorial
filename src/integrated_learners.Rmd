...
```{r include=FALSE}
table = getTab("classif")
number = nrow(table)
```
### Classification (`r number # numbers["classif"]`)
...
number = nrow(table)
```
### Regression (`r number # numbers["regr"]`)
```{r echo=FALSE,results="asis"}
makeTab(table)
# makeTab(tables[["regr"]])
```
...
number = nrow(table)
```
### Survival analysis (`r number # numbers["surv"]`)
```{r echo=FALSE,results="asis"}
makeTab(table)
# makeTab(tables[["surv"]])
```
...
```{r include=FALSE}
table = getTab("cluster")
number = nrow(table)
```
### Cluster analysis (`r number # numbers["cluster"]`)
```{r echo=FALSE,results="asis"}
makeTab(table)
...
```{r include=FALSE}
table = getTab("multilabel")
number = nrow(table)
```
### Multilabel classification (`r number # numbers["multilabel"]`)
```{r echo=FALSE,results="asis"}
makeTab(table)
