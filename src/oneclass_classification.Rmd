...
[Oxford English Dictionary]. In the sense of data, anomalies are observations, that deviate from the majority
...
p.1] [Dau et al., 2014, p.1]. An example of the former case would be anomalies caused
...
One-class classification in [%mlr] currently provides three methods:
