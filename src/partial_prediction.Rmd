...
[&plotPartialPredictionGGVIS] can be used similarly, however, since [%ggvis] currently lacks subplotting/facetting capabilities, the argument `interaction` maps one feature to an interactive sidebar where the user can select a value of one feature.
