...
As usual, you can also create the learners beforehand and provide a [list](&base::list)
of [Learner](&makeLearner) objects, or even pass a mixed [list](&base::list) of [Learner](&makeLearner)
objects and strings.
