...
If you are interested in optimizing several measures simultaneously have a look at FIXME:figure out section
...
FIXME: add 1D visual example

FIXME: integrate plotting of 2 hyperpars once PR merged.

For an in-depth exploration of hyperparameter tuning effects, check out 
